...
void SettingPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->portChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->onLanguageChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingPage::*)(int )>(_a, &SettingPage::languageChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingPage::*)(int )>(_a, &SettingPage::portChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void SettingPage::languageChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SettingPage::portChanged(int _t1)
{
